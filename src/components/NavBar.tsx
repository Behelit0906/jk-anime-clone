    ...
    <div className={classes}>
      ...
      <div className="flex items-center flex-wrap lg:flex-nowrap justify-center gap-1 lg:gap-5 lg:mr-3">
        ...
        <div className={socialMediaClasses}>
          <a href="https://www.youtube.com/@JKanimeOficial" target="_blank" className="py-[5px] lg:py-[9px] px-[7px] rounded-[10px] bg-blue-100 hover:bg-blue-150 transition-colors duration-300">
          <TfiYoutube className="text-white text-[37px]" />
          </a>
          <a href="https://www.facebook.com/jkanimado" target="_blank" className="py-[5px] lg:py-[9px] px-[7px] rounded-[10px] bg-blue-100 hover:bg-blue-150 transition-colors duration-300">
