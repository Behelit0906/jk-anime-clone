  ...
  return (
    <div className="relative flex items-center gap-2">
      <article className="flex justify-between items-center gap-2 p-[15px] w-full lg:w-[204px] xl:w-[274px] h-12 bg-white dark:bg-dark-150 rounded-[25px]">
        <input ref={inputRef} onChange={changeHandler} value={text} className="w-full pl-3 lg:w-[135px] xl:w-[205px] placeholder-orange-300 text-orange-400 font-normal focus:outline-none dark:bg-dark-150 dark:text-white dark:placeholder-white" type="text" placeholder="Buscar Anime..." />
