...
function TopList() {
  ...
  useEffect(() => {
    async function getTopList() {
      const topList = await fetch(`${apiUrl}/top/anime?limit=10&page=1`).then(res => res.json());
      console.log(topList);
      setTopList(topList.data);
    }
  ...
  return (
    <section className="flex flex-col w-full cl-2:w-[540px] px-[15px] cl-2:px-0 lg:px-[15px] md:w-[720px] lg:w-[960px] xl:w-[1170px] py-6 bg-gray-100 dark:bg-dark-100 pb-10">
      ...
      <div className="flex justify-center mt-10">
        <Link className="font-mulish text-2xl text-[#3a3a3a] transition-colors duration-200 hover:text-blue-50" to="/">
