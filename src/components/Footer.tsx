...
function Footer() {
  ...
  return(
    <footer className="w-full flex relative justify-center items-center bg-blue-50 dark:bg-dark-100 h-[188px] md:h-[161px] lg:h-[126px]">
      ...
      <div className="flex flex-wrap items-center justify-center gap-5 w-[540px] md:w-[720px] lg:w-[960px] xl:w-[1170px] px-[15px]">
        <Link className="block h-[26px] py-[2px] px-[10px] font-mulish text-white font-bold  rounded-[10px] bg-blue-100 dark:bg-dark-200" to='/'>
          Home
        </Link>
        <Link className="block h-[26px] py-[2px] px-[10px] font-mulish text-white font-bold  rounded-[10px] bg-blue-100 dark:bg-dark-200" to='/'>
          Categories
